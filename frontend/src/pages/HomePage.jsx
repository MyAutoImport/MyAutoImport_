...
import ContactForm from '../components/ContactForm'; // <-- añadimos tu ContactForm

const HomePage = () => {
  // Dejo tu estado/handlers intactos para no romper nada, aunque ahora no se usan
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Columna izquierda (tu info de contacto) */}
            <div className="space-y-8">
              <div className="space-y-6">
                <h2 className="text-3xl lg:text-4xl font-bold text-slate-900">
            ...
            {/* Columna derecha: ahora usamos tu ContactForm dentro de un Card */}
